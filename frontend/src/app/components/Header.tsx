...
const Header = () => {
	return (
		<div className='flex h-[100px] w-[1440px] justify-between items-center  '>

			<h2 className='font-semibold ml-[40px] text-primary--200 text-heading--600'>Overview</h2>
			<div className='flex justify-center items-center gap-[30px] mr-[40px] rounded-3xl'>
				...
				<img className='w-[60px] h-[60px] rounded-full' src={Mask} alt="" />
